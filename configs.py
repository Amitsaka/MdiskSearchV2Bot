...
class Config(object):
    ...
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOG4Bu1HmVseCkJ0aFIoz0sS_tNEdteOezhFbq6KI1sxN0Sc7erGQwECRi9d96JpTDoHhGDYT4FzzCcDCePAvZ4jWupk_e4KUCwq42jVxyK-xCGtORoYCJ_dDulYkw81F53KxnmJfl3QFEZpHc34FiOla422Ikh77A1YMJjHNRA0c2v49vSLpCr_ZFYh-5aivuRX0_eaP8mtd0xexywyvThbVXFHg-uQKJyrqlK-MoikzblyIQDgYZq-i5byXHHpwHL-8umr66SQBbb5szi0iSikB_hK6qaTDzof-ILeL15LjQij6b2lQyY6Hxc49bswXbt8wQBoMlL8uCmb7VHlaD_Xc0r0=")
...
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "nehaxx")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "avatar_2_0")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001896354436")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://postbot:postbot@cluster0.ouwne8q.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001699216595"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "update_channel_23")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 40))
    MDISK_API = os.getenv("MDISK_API", "3r05zNU8DDu1XvKLhDKb")
